<div id="mySidepanel" class="sidepanel">
    ...
    <a href="#"><i class="fas fa-star"></i> Wishlist</a>
    <a href="#"><i class="fas fa-cart-arrow-down"></i> Cart</a>
...
<nav class="navbar navbar-expand-sm bg-dark p-1 row m-0">
    ...
    <div class="col-sm-9 col-12" style="display: contents;">
        ...
        <button class="btn ml-2 mr-1 f20 text-light d-md-block d-none" data-toggle="tooltip" title="Account">
            <span class="d-flex align-items-center"><i class="fas fa-user"></i><span
                    class="f15 ml-2"><?php echo $_SESSION['NAME']; ?></span></span>
        </button>
        <button class="btn ml-1 mr-1 f20 text-light d-md-block d-none" data-toggle="tooltip" title="Your Cart">
            <i class="fas fa-cart-arrow-down"></i>
        </button>
        <button class="btn ml-1 mr-1 f20 text-light d-md-block d-none" data-toggle="tooltip" title="Wishlist">
            <i class="fas fa-star"></i>
        </button>
        <button class="btn ml-1 mr-1 f20 text-light d-md-block d-none" data-toggle="tooltip" title="Your Orders">
