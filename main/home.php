...
<div class="container-fluid text-center p-0">
    ...
    <nav class="navbar navbar-expand-sm bg-dark p-1 row">
        <div class="col-sm-3 col-12 " style="display: contents;">
            <button class="btn border border-light ml-4" data-toggle="tooltip" title="More">
            ...
            <button class="btn ml-1 mr-2 f20 text-light d-sm-none d-block" data-toggle="tooltip" title="Logout">
                <i class="fas fa-sign-out-alt"></i>
            </button>
        </div>
        <div class="col-sm-9 col-12" style="display: contents;">
            <div class="input-group mr-3 ml-3 mb-1 m-sm-auto">
            ...
            <button class="btn ml-1 mr-2 f20 text-light d-sm-block d-none" data-toggle="tooltip" title="Logout">
                <i class="fas fa-sign-out-alt"></i>
            </button>
        </div>
    </nav>
